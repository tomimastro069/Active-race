...
The system SHALL support mapping users to roles within specific academic contexts (such as carreras, cohortes, materias, or comisiones) with temporal constraints (`desde` and `hasta`).
